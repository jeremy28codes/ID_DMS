...
{
    public class DBM_SystemUserRoleSectionAccess
    {
        string sConnectionString = ConfigurationManager.ConnectionStrings["sConnectionString"].ToString();

        #region Basic Crud Functions
        //GET ALL
        public List<System_user_role_section_access> ListAll()
        {
            List<System_user_role_section_access> list = new List<System_user_role_section_access>();

            using (SqlConnection connection = new SqlConnection(sConnectionString))
            {
                SqlCommand command = connection.CreateCommand();
                command.CommandType = CommandType.StoredProcedure;
                command.CommandText = "spSystem_user_role_section_access_ListAll";
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    list.Add(new System_user_role_section_access
                    {
                        ...
                        system_web_section_id = Convert.ToInt32(dr["system_web_section_id"]),
                        system_web_section_code = dr["system_web_section_code"].ToString(),
                        system_web_section_name = dr["system_web_section_name"].ToString(),
                        system_web_section_description = dr["system_web_section_description"].ToString(),
                        system_web_section_link = dr["system_web_section_link"].ToString(),
                        system_web_section_icon = dr["system_web_section_icon"].ToString(),
                        system_web_section_ctr = Convert.ToInt32(dr["system_web_section_ctr"]),
                        system_web_section_is_active = Convert.ToInt32(dr["system_web_section_is_active"]),
        ...
        //GET BY ID
        public System_user_role_section_access GetBy_ID(int id)
        {
            System_user_role_section_access item = new System_user_role_section_access();

            using (SqlConnection connection = new SqlConnection(sConnectionString))
            {
                SqlCommand command = connection.CreateCommand();
                command.CommandType = CommandType.StoredProcedure;
                command.CommandText = "spSystem_user_role_section_access_GetBy_ID";
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    item.system_web_section_id = Convert.ToInt32(dr["system_web_section_id"]);
                    item.system_web_section_code = dr["system_web_section_code"].ToString();
                    item.system_web_section_name = dr["system_web_section_name"].ToString();
                    item.system_web_section_description = dr["system_web_section_description"].ToString();
                    item.system_web_section_link = dr["system_web_section_link"].ToString();
                    item.system_web_section_icon = dr["system_web_section_icon"].ToString();
                    item.system_web_section_ctr = Convert.ToInt32(dr["system_web_section_ctr"]);
                    item.system_web_section_is_active = Convert.ToInt32(dr["system_web_section_is_active"]);
        ...
        //CREATE
        public int Insert(System_user_role_section_access item)
        {
            int id = 0;
            using (SqlConnection connection = new SqlConnection(sConnectionString))
            {
                SqlCommand command = new SqlCommand("spSystem_user_role_section_access_Insert", connection);
                command.CommandType = CommandType.StoredProcedure;
                ...
                command.Parameters.Add("@system_web_section_id", SqlDbType.Int).Value = item.system_web_section_id;
        ...
        //UPDATE
        public int Update(System_user_role_section_access item)
        {
            int id = 0;
            using (SqlConnection connection = new SqlConnection(sConnectionString))
            {
                SqlCommand command = new SqlCommand("spSystem_user_role_section_access_Update", connection);
                command.CommandType = CommandType.StoredProcedure;
        ...
        //DELETE
        public int Delete(System_user_role_section_access item)
        {
            int id = 0;
            using (SqlConnection connection = new SqlConnection(sConnectionString))
            {
                SqlCommand command = new SqlCommand("spSystem_user_role_section_access_Delete", connection);
                command.CommandType = CommandType.StoredProcedure;
                command.Parameters.Add("@id", SqlDbType.Int).Value = item.id;
        ...
        public System_user_role_section_access GetBy_SystemRoleID(int system_role_id)
        {
            System_user_role_section_access item = new System_user_role_section_access();
            ...
            using (SqlConnection connection = new SqlConnection(sConnectionString))
            {
                SqlCommand command = connection.CreateCommand();
                command.CommandType = CommandType.StoredProcedure;
                command.CommandText = "spSystem_user_role_section_access_GetBy_SystemRoleID";
        ...
        public List<System_user_role_section_access> ListBy_SystemRoleID_And_SystemWebModuleID(int system_role_id, int system_web_module_id)
        {
            List<System_user_role_section_access> list = new List<System_user_role_section_access>();
            ...
            using (SqlConnection connection = new SqlConnection(sConnectionString))
            {
                SqlCommand command = connection.CreateCommand();
                command.CommandType = CommandType.StoredProcedure;
                command.CommandText = "spSystem_user_role_section_access_ListBy_SystemRoleID_And_SystemWebModuleID";
                command.Parameters.Add("@system_role_id", SqlDbType.Int).Value = system_role_id;
        ...
        public List<System_user_role_section_access> ListAll_SystemRoleID(int system_role_id)
        {
            List<System_user_role_section_access> list = new List<System_user_role_section_access>();
            ...
            using (SqlConnection connection = new SqlConnection(sConnectionString))
            {
                SqlCommand command = connection.CreateCommand();
                command.CommandType = CommandType.StoredProcedure;
                command.CommandText = "spSystem_user_role_section_access_ListAll_SystemRoleID";
                command.Parameters.Add("@system_role_id", SqlDbType.Int).Value = system_role_id;
                SqlDataAdapter sqlDA = new SqlDataAdapter(command);
                DataTable dt = new DataTable();
        ...
        public List<System_user_role_section_access> ListBy_RoleID(int system_role_id, int system_web_module_id)
        {
            List<System_user_role_section_access> list = new List<System_user_role_section_access>();
