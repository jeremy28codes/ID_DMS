...
namespace DMS.Models
{
    public class System_units
    {
        ...
        public string system_division_code { get; set; }
        public string system_division_name { get; set; }
        public string system_division_description { get; set; }
        public int system_division_ctr { get; set; }
