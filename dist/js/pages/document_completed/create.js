$(document).ready(function () {
    ...
    $.validator.setDefaults({
        submitHandler: function () {
            ...
            $.ajax({
                type: 'POST',
                url: base_url + "DocumentCompleted/Create",
                data: formData,
                contentType: false,
                cache: false,
                processData: false,
                ...
                if (response.status) {
                    ...
                    swalWithBootstrapButtons.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location = base_url + "DocumentCompleted/Create";
                        } else if (
                            result.dismiss === Swal.DismissReason.cancel
                        ) {
                            window.location = base_url + "DocumentCompleted/Edit/" + response.document_id;
                        }
                    });
