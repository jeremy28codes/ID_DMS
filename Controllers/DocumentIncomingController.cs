...
{
    public class DocumentIncomingController : Controller
    {
        ...
        public string Section = "Incoming";
        public string Title = "DMS - Incoming Documents";
        public string Home = "DocumentIncoming";
        ...
        public ActionResult Index()
        {
            ...
            var script_paths = new List<Scripts_path>
            {
                ...
                new Scripts_path {path = "/dist/js/pages/document_incoming/index.js"}
            };

            ViewData["Styles"] = style_paths;
            ViewData["Scripts"] = script_paths;

            var List = Documents.ListAll_Incoming();
            return View(List);
        }

        //// GET: DocumentIncoming/Details/5
        //public ActionResult Details(int id)
        //{
        //    return View();
        //}

        // GET: DocumentIncoming/Create
        [HttpGet]
        public ActionResult Create()
        {
            ...
            var script_paths = new List<Scripts_path>
            {
                ...
                new Scripts_path {path = "/dist/js/pages/document_incoming/create.js"}
            };
        ...
        public JsonResult Create(FormCollection collection) 
        {
            ...
            try
            {
                var generate_ref_num = Documents.Generate_ReferenceNumber(Convert.ToInt32(collection["from_system_division_id"]), rgv_action_type_id_IN);
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if (document_id > 0)
                    {
                        ...
                        document_reference_numbers.rgv_action_type_id = rgv_action_type_id_IN;
                        document_reference_numbers.system_department_id = Convert.ToInt32(collection["from_system_department_id"]);
                        document_reference_numbers.system_division_id = Convert.ToInt32(collection["from_system_division_id"]);
                        ...
                        document_route_logs.from_system_unit_id = 0;
        ...
        public ActionResult Edit(int id)
        {
            ...
            var script_paths = new List<Scripts_path>
            {
                ...
                new Scripts_path {path = "/plugins/jquery-validation/jquery.validate.min.js"},
                new Scripts_path {path = "/plugins/jquery-validation/additional-methods.min.js"},
                new Scripts_path {path = "/dist/js/pages/document_incoming/edit.js"}
            };
        ...
        public ActionResult Outgoing(int id)
        {
            ...
            var script_paths = new List<Scripts_path>
            {
                ...
                new Scripts_path {path = "/plugins/jquery-validation/jquery.validate.min.js"},
                new Scripts_path {path = "/plugins/jquery-validation/additional-methods.min.js"},
                new Scripts_path {path = "/dist/js/pages/document_incoming/outgoing.js"}
            };
        ...
        [HttpPost]
        public JsonResult Outgoing(FormCollection collection)
        {
            bool isInserted = false;
            var errMessage = "Something went wrong! Please contact technical support.";
        ...
        public ActionResult Completed(int id)
        {
            ...
            var script_paths = new List<Scripts_path>
            {
                ...
                new Scripts_path {path = "/plugins/jquery-validation/jquery.validate.min.js"},
                new Scripts_path {path = "/plugins/jquery-validation/additional-methods.min.js"},
                new Scripts_path {path = "/dist/js/pages/document_incoming/completed.js"}
            };
        ...
        public ActionResult Forward(int id)
        {
            ...
            var script_paths = new List<Scripts_path>
            {
                ...
                new Scripts_path {path = "/plugins/jquery-validation/jquery.validate.min.js"},
                new Scripts_path {path = "/plugins/jquery-validation/additional-methods.min.js"},
                new Scripts_path {path = "/dist/js/pages/document_incoming/forward.js"}
            };

            ViewData["Styles"] = style_paths;
            ViewData["Scripts"] = script_paths;

            ViewData["system_units"] = SystemUnits.ListBy_SystemDepartmentDivisionID(Convert.ToInt32(Session["system_department_id"]), Convert.ToInt32(Session["system_division_id"]));
            ViewData["document_types"] = SystemReferenceGroupValues.ListBy_GroupCodeDepartmentDivisionID("Document Types", Convert.ToInt32(Session["system_department_id"]), Convert.ToInt32(Session["system_division_id"]));
            ViewData["document_statuses"] = SystemReferenceGroupValues.ListBy_GroupCodeDepartmentDivisionID("Document Statuses", Convert.ToInt32(Session["system_department_id"]), Convert.ToInt32(Session["system_division_id"]));
            ViewData["document"] = Documents.GetBy_ID(id);
        ...
        [HttpPost]
        public JsonResult Forward(FormCollection collection)
        {
            bool isInserted = false;
            var errMessage = "Something went wrong! Please contact technical support.";
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if (document_id > 0)
                    {
                        ...
                        document_route_logs.to_system_department_id = Convert.ToInt32(Session["system_department_id"]);
                        document_route_logs.to_system_division_id = Convert.ToInt32(Session["system_division_id"]);
                        document_route_logs.to_system_unit_id = Convert.ToInt32(collection["to_system_unit_id"]); ;
                        document_route_logs.to_name = collection["to_name"].ToString();
                        document_route_logs.from_system_department_id = Convert.ToInt32(Session["system_department_id"]);
                        document_route_logs.from_system_division_id = Convert.ToInt32(Session["system_division_id"]);
                        document_route_logs.from_system_unit_id = Convert.ToInt32(Session["system_unit_id"]);
