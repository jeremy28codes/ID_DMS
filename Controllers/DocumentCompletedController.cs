...
{
    public class DocumentCompletedController : Controller
    {
        ...
        public string Section = "Completed";
        public string Title = "DMS - Completed Documents";
        public string Home = "DocumentCompleted";
        ...
        public ActionResult Index()
        {
            ...
            var script_paths = new List<Scripts_path>
            {
                ...
                new Scripts_path {path = "/dist/js/pages/document_completed/index.js"}
            };

            ViewData["Styles"] = style_paths;
            ViewData["Scripts"] = script_paths;

            var List = Documents.ListAll_Completed();
            return View(List);
        }

        // GET: DocumentCompleted/Details/5
        public ActionResult Details(int id)
        {
            return View();
        }

        // GET: DocumentCompleted/Create
        [HttpGet]
        public ActionResult Create()
        {
            ...
            var script_paths = new List<Scripts_path>
            {
                ...
                new Scripts_path {path = "/dist/js/pages/document_completed/create.js"}
            };
        ...
        public JsonResult Create(FormCollection collection)
        {
            ...
            try
            {
                ...
                int document_id = 0;
                var generate_ref_num = Documents.Generate_ReferenceNumber(Convert.ToInt32(Session["system_division_id"]), rgv_action_type_id_COMPLETED);
                ...
                documents.completed_at = Convert.ToDateTime(collection["route_date"]).ToString("MM-dd-yyyy") +" " + Convert.ToDateTime(collection["route_time"]).ToString("HH:mm");
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if (document_id > 0)
                    {
                        ...
                        document_reference_numbers.rgv_action_type_id = rgv_action_type_id_COMPLETED;
        ...
        public ActionResult Edit(int id)
        {
            ...
            var script_paths = new List<Scripts_path>
            {
                ...
                new Scripts_path {path = "/plugins/jquery-validation/jquery.validate.min.js"},
                new Scripts_path {path = "/plugins/jquery-validation/additional-methods.min.js"},
                new Scripts_path {path = "/dist/js/pages/document_completed/edit.js"}
            };
        ...
        //// GET: DocumentCompleted/Delete/5
        //public ActionResult Delete(int id)
        //{
        //    return View();
        //}

        // POST: DocumentCompleted/Delete/5
        [HttpPost]
        ...
        public ActionResult Outgoing(int id)
        {
            ...
            var script_paths = new List<Scripts_path>
            {
                ...
                new Scripts_path {path = "/plugins/jquery-validation/jquery.validate.min.js"},
                new Scripts_path {path = "/plugins/jquery-validation/additional-methods.min.js"},
                new Scripts_path {path = "/dist/js/pages/document_completed/outgoing.js"}
            };
        ...
        public ActionResult Forward(int id)
        {
            ...
            var script_paths = new List<Scripts_path>
            {
                ...
                new Scripts_path {path = "/plugins/jquery-validation/jquery.validate.min.js"},
                new Scripts_path {path = "/plugins/jquery-validation/additional-methods.min.js"},
                new Scripts_path {path = "/dist/js/pages/document_completed/forward.js"}
            };
